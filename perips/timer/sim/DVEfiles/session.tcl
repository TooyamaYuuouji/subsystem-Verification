...
# DVE full session
# Saved on Fri Aug 4 21:58:25 2023
# Designs open: 1
...
#<Session mode="Full" path="/home/tooyama/Code/Project/APB3VIP-4-CMSDK/perips/timer/sim/DVEfiles/session.tcl" type="Coverage">
...
gui_show_window -window ${CovTopLevel.1} -show_state maximized -rect {{0 28} {1850 890}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 599} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1850} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_cov  -hier {out.vdb}   -testdir {out.vdb} -autoopen False  -test { {out/timer_test_5} } -merge {MergedTest}
